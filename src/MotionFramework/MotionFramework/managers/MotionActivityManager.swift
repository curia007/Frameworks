...
public enum MotionActivityContext: String, CustomStringConvertible
{
...
/**
`MotionActivityContextDelegate` exists to inform delegates of motion context changes.
These contexts can be used to enable motion aware application specific behavior.
*/

public protocol MotionActivityContextDelegate: class
{
    func lowIntensityContextStarted(manager: MotionActivityManager)
    func mediumIntensityContextStarted(manager: MotionActivityManager)
    func highIntensityContextStarted(manager: MotionActivityManager)
    func drivingContextStarted(manager: MotionActivityManager)
    func didEncounterAuthorizationError(manager: MotionActivityManager)
}

public class MotionActivityManager: Manager
{
    ...
    weak var delegate: MotionActivityContextDelegate?
    
    var currentContext = MotionActivityContext.LowIntensity
    
    let motionQueue: NSOperationQueue = {
        let motionQueue = NSOperationQueue()
        
        motionQueue.name = "com.carmelouria.motion-framework.motionActivityManager"
    ...
    */
    ...
    var hasAltitudeChangedRecently: Bool {
        ...
        return fabs(firstAltitude.doubleValue - lastAltitude.doubleValue) > MotionActivityManager.metersForSignificantAltitudeChange
    }
    ...
    var isUserPaceHigh: Bool {
        ...
        */
        ...
        return pace < MotionActivityManager.highPace
    }
    ...
    var isUserPaceMedium: Bool {
        ...
        */
        ...
        the high pace.
        */
        return pace < MotionActivityManager.mediumPace && pace > MotionActivityManager.highPace
    }
    ...
    func createActivityDataWithActivities(activities: [CMMotionActivity], completionHandler: Void -> Void) -> [Activity]
    {
        ...
        */
        ...
        let queue = dispatch_queue_create("com.carmelouria.motion-framework.resultQueue", DISPATCH_QUEUE_SERIAL)
    ...
    func savePedometerData(pedometerData: CMPedometerData)
    {
        ...
        if recentPedometerData.count > MotionActivityManager.maxPedometerSamples
        {
    ...
    func saveAltitudeData(altitude: CMAltitudeData)
    {
        ...
        if recentAlitudeData.count > MotionActivityManager.maxAltitudeSamples
        {
    ...
    func saveMotionActivity(activity: CMMotionActivity)
    {
        ...
        if recentMotionActivities.count > MotionActivityManager.maxActivitySamples
        {
